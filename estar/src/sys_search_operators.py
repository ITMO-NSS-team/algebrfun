...
# TODO Здесь задается оператор эволюции, который содержит в себе основную логику эволюции, оптимизации и тд.
